...
if(isset($_GET['status']))
{
  ...
  if($_GET['status'] == 'cancelled')
  {
    ...
    try{
      ...
      echo "<script>window.location.assign('atm-funding')</script>";
    }
  ...
  elseif($_GET['status'] == 'successful' || $_GET['status'] == 'completed')
  {
    ...
    //   echo "</pre>";
      ...
      if($res->status == "success") {
        ...
        {
          $status_message = "Fraud Transaction Detected";
      ...
      {
        $status_message = "Can not process payment [Process]!";
        ...
        $_SESSION['error'] = 'Can not process payment [Process]!';
        echo "<script>window.location.assign('atm-funding')</script>";
